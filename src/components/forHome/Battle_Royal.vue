<template>
  ...
  export default {
    ...
    setup() {
      ...
      const scroll_left = () => {
        let content = document.querySelector(".battleRoyale");
      ...
      onBeforeMount(() => {
        fetch('https://mmo-games.p.rapidapi.com/games?category=battle-royale', options)
