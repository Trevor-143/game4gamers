<template>
  ...
  export default {
    ...
    setup() {
      ...
      const scroll_left = () => {
        let content = document.querySelector(".fiction");
      ...
      onBeforeMount(() => {
        fetch('https://mmo-games.p.rapidapi.com/games?category=sci-fi', options)
